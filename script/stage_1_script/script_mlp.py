...
if 1:
    ...
    data_obj.dataset_source_folder_path = r'\data\stage_1_data'
    data_obj.dataset_source_file_name = r'\toy_data_file.txt'

    method_obj = Method_MLP('multi-layer perceptron', '')

    result_obj = Result_Saver('saver', '')
    result_obj.result_destination_folder_path = r'\result\stage_1_result\MLP_'
